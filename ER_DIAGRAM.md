...
- **Schema additions (migrations `20260802120000` & `20260810100000`)**: `content_type` ENUM(`diagram_only`, `diagram_and_video`) DEFAULT `diagram_only`; `image_path` TEXT (GCS `gs://` URI or Data URI for PNG); `image_url` TEXT (public HTTPS URL or Data URI); `video_path` TEXT; `video_url` TEXT; `thumbnail_path` TEXT; `summary` STRING(200) (student-facing ≤15-word caption generated by Gemini).
