...
- **JWT Authentication**: Short/Medium lived Bearer JSON Web Tokens containing `id`, `role`, `school_id`, `school_board`, and profile claims (`teacher_id`, `student_id`, `driver_id`).
